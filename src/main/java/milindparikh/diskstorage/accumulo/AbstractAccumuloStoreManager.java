...
public abstract class AbstractAccumuloStoreManager extends DistributedStoreManager implements OrderedKeyValueStoreManager {
    ...
    public AbstractAccumuloStoreManager(Configuration storageConfig) {
        ...
        this.instanceName = storageConfig.getString(INSTANCE_KEY, INSTANCE_DEFAULT);
        this.zookeeperNames = storageConfig.getString(ZOOKEEPERS_KEY, ZOOKEEPERS_DEFAULT);
